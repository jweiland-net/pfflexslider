<?php
namespace JWeiland\Pfflexslider\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class JWeiland\Pfflexslider\Controller\SliderController.
 *
...
class SliderControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \JWeiland\Pfflexslider\Controller\SliderController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('JWeiland\\Pfflexslider\\Controller\\SliderController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllSlidersFromRepositoryAndAssignsThemToView() {
		...
		$sliderRepository = $this->getMock('JWeiland\\Pfflexslider\\Domain\\Repository\\SliderRepository', array('findAll'), array(), '', FALSE);
